...
const ContactForm = () => {
    ...
    return (
        ...
        <div className="contacto-container bg-img" loading="lazy">
            <section className="py-3 py-md-5">
                <div className="container">
                    <div className="row justify-content-md-center">
                        <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                            <h1 className="text-white text-uppercase text-center">Contacto</h1>
                            ...
                            <div className="bg-white border rounded shadow-sm overflow-hidden">
                                <form onSubmit={handleSubmit}>
                                    <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                                        ...
                                        <div className="col-12 col-md-6">
                                            <label htmlFor="phone" className="form-label">Número de Teléfono <span className="text-danger">*</span></label>
                                            <div className="input-group">
                                                <span className="input-group-text">
