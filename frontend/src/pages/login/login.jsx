...
const Login = () => {
    ...
    return (
        <div className="hero"> 
            <div className="py-3 py-md-5 h-100">
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="text-center mb-5">
                                            <h1 className="display-6 lead text-uppercase">Sport League Panama</h1>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-container"> {/* Contenedor adicional para el formulario */}
